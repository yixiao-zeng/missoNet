...
```{r, fig.align = 'center', fig.height = 4, fig.width = 5.9, dev = "svg"}
...
```{r, fig.align = 'center', fig.show = "hold", fig.height = 2.4, fig.width = 6.9, dev = "svg"}
...
```
```{r, echo = FALSE}
load(system.file("extdata", "cvfitBM.rda", package = "missoNet"))
```
...
```
```{r, echo = FALSE}
load(system.file("extdata", "cvfit2BM.rda", package = "missoNet"))
```
...
```
```{r, echo = FALSE, fig.align = 'center', fig.height = 4.8, fig.width = 6.6, dev = "svg"}
