#' missoNet: a package for multivariate regression with missing outputs and conditional network estimation.
#'
...
#' generateData: generate simulation data by a certain type of missing mechanism.
#'
#' @docType package
#' @name missoNet
